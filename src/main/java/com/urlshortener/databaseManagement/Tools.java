...
public class Tools {
    ...
    //This variable should be provenised 
    private static final String serverAddress = "149.91.88.209";//Or 127.0.0.1 when in local or when on the server "149.91.88.209";
